...
const {REACT_APP_FRANCE_CONNECT_CREATE_SERVICE_PROVIDER_URI: FRANCE_CONNECT_CREATE_SERVICE_PROVIDER_URI} = process.env
...
const DonneesDescription = () => (
  <div className='information-text'>
    ...
    <p>Vous pouvez consulter le <a href='/docs/cst-dgfip.pdf' target='_blank'>Contrat de Service Technique (CST)</a> pour voir le détail des données disponibles.</p>
    <p>
...
const Dgfip = ({match: {params: {enrollmentId}}}) => (
