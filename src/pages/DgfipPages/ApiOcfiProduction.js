...
const target_api = 'api_ocfi_production';
const steps = ['api_ocfi_sandbox', target_api];

const ApiOcfiProduction = ({
  match: {
    params: { enrollmentId },
  },
}) => (
...
ApiOcfiProduction.defaultProps = {
  match: {
    params: {
      enrollmentId: null,
    },
...
export default ApiOcfiProduction;
