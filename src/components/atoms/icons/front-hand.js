...
// Source: https://fonts.google.com/icons?selected=Material+Icons+Outlined:front_hand
const FrontHandIcon = ({ color, size }) => (
  <svg
...
FrontHandIcon.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
};

FrontHandIcon.defaultProps = {
  color: 'black',
  size: 24,
};
