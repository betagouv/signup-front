  ...
  <>
    ...
    <div className="form__group">
      ...
      <label htmlFor="information_agreement" className="label-inline">
        Je m'engage à tenir l'équipe CartoBio informée des productions établies
        avec les données géographiques — nous les mettrons en valeur pour
        stimuler une variété d'usages.
      </label>
    </div>
  </>
);

CartoBioAdditionalAgreements.propTypes = {
