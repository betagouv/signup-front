...
const {REACT_APP_FRANCE_CONNECT_AUTHORIZE_URI: FRANCE_CONNECT_AUTHORIZE_URI, REACT_APP_FRANCE_CONNECT_CREATE_SERVICE_PROVIDER_URI: FRANCE_CONNECT_CREATE_SERVICE_PROVIDER_URI} = process.env
