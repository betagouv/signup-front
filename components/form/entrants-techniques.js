...
const EntrantsTechniques = ({disabled, onChange, upload, enrollment: {
  documents,
    ...
    <React.Fragment>
      ...
      <div className='form__group'>
        {productionCertificate ? (
          <label htmlFor='production_certificate'><a href={`${BACK_HOST + productionCertificate.attachment.url}?token=${token}`}>Certificat de production</a></label>
        ) : (
          <label htmlFor='production_certificate'>Certificat de production</label>
        )}
        <input type='file' onChange={upload} disabled={disabled} name='Document::ProductionCertificatePublicKey' id='production_certificate' />
      </div>
      <div className='form__group'>
        <label htmlFor='autorite_certification'>Autorité de certification</label>
        <input type='text' onChange={onChange} name='autorite_certification' id='autorite_certification' disabled={disabled} value={autorite_certification} />
      </div>
      <div className='form__group'>
        ...
        <input type='text' onChange={onChange} name='ips_de_production' id='ips_de_production' disabled={disabled} value={ips_de_production} />
      </div>
      ...
      <div className='form__group'>
        ...
        <input type='text' onChange={onChange} name='autorite_homologation_nom' id='autorite_homologation_nom' disabled={disabled} value={autorite_homologation_nom} />
      </div>
      <div className='form__group'>
        <label htmlFor='autorite_homologation_fonction'>Fonction de l&apos;autorité d&apos;homologation</label>
        <input type='text' onChange={onChange} name='autorite_homologation_fonction' id='autorite_homologation_fonction' disabled={disabled} value={autorite_homologation_fonction} />
      </div>
      <div className='form__group'>
        <label htmlFor='date_homologation'>Date de début l&apos;homologation</label>
        <input type='date' onChange={onChange} name='date_homologation' id='date_homologation' disabled={disabled} value={date_homologation} />
      </div>
      <div className='form__group'>
        <label htmlFor='date_fin_homologation'>Date de fin de l&apos;homologation</label>
        <input type='date' onChange={onChange} name='date_fin_homologation' id='date_fin_homologation' disabled={disabled} value={date_fin_homologation} />
      </div>
      ...
      <div className='form__group'>
        <input onChange={onChange} checked={recette_fonctionnelle} type='checkbox' name='recette_fonctionnelle' id='checkbox-recette_fonctionnelle' disabled={disabled} />
