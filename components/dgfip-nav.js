...
const DgfipNav = () => (
  <nav className='side-pane'>
    <ul className='side-pane__menu'>
      <li className='text-center'><a className='side-pane__link' href='https://www.impots.gouv.fr/'><img src='/static/images/logo-dgfip.png' style={{mixBlendMode: 'multiply'}} /></a></li>
